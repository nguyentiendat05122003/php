    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <button class="btn add-new btn-primary" style="float:right" tabindex="0" >
                <a  style="color:#fff;text-decoration: none;" href="{{route('products.add')}}">
                    <span>
                ...
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between align-items-center row py-3 gap-3 gap-md-0">
                        <div class="col-md-4 product_status">
                            <select name="Status" id="ProductStatus" class="form-select text-capitalize">
                        ...
                        <div class="col-md-4 product_category">
                            <select id="ProductCategory" name="categoryID" class="form-select text-capitalize">
                        ...
                        <div class="col-md-4 product_stock">
                            <select id="ProductStock" name="brandID" class="form-select text-capitalize">
                                <option value="0">Brand</option>
                                @if(!empty($allBrand))
                                  @foreach ($allBrand as $item)
                                    <option value="{{$item->id}}" {{request()->brandID == $item->id ? 'selected': false}}>{{$item->name}}</option>
                                  @endforeach
                                  @endif
                            </select></div>
                    </div>
                               ...
                               <tbody>
                                   ...
                                   @foreach ($productList as $key =>$item)
                                       <tr>
                                           ...
                                           <td>{{$item->name}}</td>
                                           <td>{{$item->rating}}</td>
                                           <td>{!!$item->active == 0 ? '<button class="btn btn-danger">InActive</button>' : '<button class="btn btn-success">Active</button>'!!}</td>
                                           <td>
