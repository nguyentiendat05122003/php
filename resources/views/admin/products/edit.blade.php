...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="{{route('products.postEdit')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-header mb-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                    <div class="d-flex flex-column justify-content-center">
                      <h4 class="mb-1 mt-3">Edit a Product</h4>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div class="mb-3">
                            ...
                            <input value= "{{$productDetail->name}}" type="text" class="form-control" id="ecommerce-product-name" placeholder="Product title" name="nameProduct" aria-label="Product title">
                          </div>
                          <div class="row mb-3">
                            <div class="col">
                          ...
                          <div>
                            <div>
                                ...
                                <div class="form">
                                    <textarea  class="wysihtml5 form-control" name="desc" row="5">{{old('desc') ?? $productDetail->desc}}</textarea>
                                </div>
                              </div>
                          </div>
                        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div  class="dropzone needsclick dz-clickable" id="dropzone-basic">
                            ...
                            <input value={{old('thumb') ?? $productDetail->thumb}} type="file" name="thumb" id="thumb" class="upload-input" onchange="readURL(this)"/>
                            <img  id="img" width="100px" class="img-thumbnail image-thumb rounded mx-auto d-block" height="100px" src="{{URL::asset('storage/'.$productDetail->thumb)}}" alt="your image" />
                          </div>
                        </div>
                    </div>
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="row g-2 justify-content-center">
                            <input type="file"  value={{old('detail_images') ?? $productDetail->detail_images}}  name="images[]" class="form-control @error('image.*') is-invalid @enderror" multiple>
                        </div>
                        <div class="d-flex justify-content-center">
                          @if(!empty($detailImage))
                            @foreach ($detailImage as $item)
                            <img  id="img" width="100px" class="img-thumbnail image-thumb rounded mx-2 d-block" height="100px" src="{{URL::asset('storage/'.$item)}}" alt="your image" />
                            @endforeach
                          @endif
                        </div>
                      </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div class="mb-3 col ecommerce-select2-dropdown">
                            ...
                            <div class="position-relative">
                              ...
                              @foreach ($allCategory as $item)
                                <option value="{{$item->id}}" {{old('categoryID') == $item->id || $productDetail->categoryID == $item->id? 'selected':false}}>{{$item->name}}</option>
                              @endforeach
                              @endif
                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="7" style="width: 251.771px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-category-org-container"><span class="select2-selection__rendered" id="select2-category-org-container" role="textbox" aria-readonly="true"></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span></div>
                          </div>
                          <div class="mb-3 col ecommerce-select2-dropdown">
                            ...
                            <div class="position-relative">
                              ...
                              @foreach ($allBrand as $item)
                                <option value="{{$item->id}}" {{old('brandID') == $item->id || $productDetail->brandID== $item->id? 'selected':false}}>{{$item->name}}</option>
                              @endforeach
                              @endif
                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="5" style="width: 251.771px;"><span class="selection">
                          ...
                          <div class="mb-3 col ecommerce-select2-dropdown">
                            ...
                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="9" style="width: 251.771px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-collection-container"><span class="select2-selection__rendered" id="select2-collection-container" role="textbox" aria-readonly="true"></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span></div>
                          </div>
                          <!-- Status -->
                          <div class="mb-3 col ecommerce-select2-dropdown">
            ...
            <!-- Page Heading -->
            <form method="POST" action="{{route('products.addDetail')}}">
                @csrf
                <div class="card-header">
                    <h5 class="card-title">Detail product</h5>
                    <div class="d-flex justify-content-between align-items-center row py-3 gap-3 gap-md-0" style="justify-content: flex-end !important;">

                        <div class="col-md-4 product_color">
                            <select id="ProductCategory" name="colorID" class="form-select text-capitalize">
                                <option value="0">Color</option>
                                @if(!empty($allColor))
                                  @foreach ($allColor as $item)
                                    <option value="{{$item->id}}" {{request()->colorID == $item->id ? 'selected': false}}>{{$item->value}}</option>
                                  @endforeach
                                  @endif
                            </select>
                        </div>
                        <div class="col-md-4 product_size">
                            <select id="ProductCategory" name="sizeID" class="form-select text-capitalize">
                                <option value="0">Size</option>
                                @if(!empty($allSize))
                                  @foreach ($allSize as $item)
                                    <option value="{{$item->id}}" {{request()->sizeID == $item->id ? 'selected': false}}>{{$item->value}}</option>
                                  @endforeach
                                  @endif
                            </select>
                        </div>
                        <div class="col-md-4 product_provider">
                            <select id="ProductCategory" name="providerID" class="form-select text-capitalize">
                                <option value="0">Provider</option>
                                @if(!empty($allProvider))
                                  @foreach ($allProvider as $item)
                                    <option value="{{$item->id}}" {{request()->providerID == $item->id ? 'selected': false}}>{{$item->name}}</option>
                                  @endforeach
                                  @endif
                            </select>
                        </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0 justify-content-between align-items-center">
                        <div class=" ms-n2 " style="margin-left: auto">
                            <div id="DataTables_Table_0_filter" class="dataTables_filter">
                        <label>
                            <input name="price" type="text" class="form-control mt-3" placeholder="Price" aria-controls="DataTables_Table_0"></label>
                            <button class="btn btn-primary" style="margin-bottom: 6px;margin-left:10px" type="submit">Add detail product</button>
                        </div>
                    </div>
                    <div class="card-body">
                        <div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($listDetail as $key => $item)
                                        <tr>
                                            ...
                                            <td>{{$item->name}}</td>
                                            <td>
                                                <button class="btn btn-warning"><a style="text-decoration: none;color:#000;" href="{{route('products.getEditDetail',['id'=> $item->id])}}">Edit</a></button>
                                            </td>
                                            <td>
                                                <button class="btn btn-dark"><a style="text-decoration: none;color:#fff;" onclick="return confirm('Bạn chắc chắn muốn xóa sản phẩm không?')" href="{{route('products.delete',['id'=> $item->id])}}">Delete</a></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                    @else
