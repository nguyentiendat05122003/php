...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form method="POST" action="{{route('payment.postEdit',['id'=> $id])}}">
            @csrf
               <div class="card-body">
                       <div>
                               ...
                               <tbody>
                                   ...
                                   @foreach ($payments as $key =>$item)
                                       <tr>
                                           ...
                                           <td>{{$item->color}}</td>
                                           <td>
                                               <button class="btn btn-dark"><a style="text-decoration: none;color:#fff;" onclick="return confirm('Bạn chắc chắn muốn xóa sản phẩm không?')" href="{{route('products.delete',['id'=> $item->paymentID])}}">Delete</a></button>
                                           </td>
                                       </tr>
                                   @endforeach
                                   @else
                ...
                <button type="submit" style="float:right" class="btn btn-success">Paid</button>
          </form>
        </div>
