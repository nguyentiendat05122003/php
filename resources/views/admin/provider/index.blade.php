    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <button class="btn add-new btn-primary" style="float:right" tabindex="0" >
                <a  style="color:#fff;text-decoration: none;" href="{{route('provider.add')}}">
                    <span>
          ...
          <form>
               <div class="card-body">
                       <div>
                               ...
                               <tbody>
                                   ...
                                   @foreach ($providers as $key =>$item)
                                       <tr>
                                           ...
                                           <td>{{$item->email}}</td>
                                           <td>
                                               <button class="btn btn-warning"><a style="text-decoration: none;color:#000;">Edit</a></button>
                                           </td>
                                           <td>
                                               <button class="btn btn-dark"><a style="text-decoration: none;color:#fff;" onclick="return confirm('Bạn chắc chắn muốn xóa nhà cung cấp không?')" href="{{route('provider.delete',['id'=> $item->id])}}">Delete</a></button>
                                           </td>
                                       </tr>
                                   @endforeach
                                   @else
                           ...
                           {{-- <div style="display: flex;justify-content: center;">{{$providers->appends($_GET)->links()}}</div> --}}
                       </div>
                   </div>
               </div>
          </form>
