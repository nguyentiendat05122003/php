        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="row pb-3">
                        ...
                        <div class="col-12 pb-1">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <div class="d-flex gap-3">
                                    <div class="">
                                        <div class="btn-group flex gap-2" style="">
                                            ...
                                            <select id="ProductCategory" name="categoryID" class="form-select text-capitalize" style="margin-left:'10px'">
                    ...
                    <div class="text-center" colspan="4">No one product</div>
                    @endif
                    <div class="col-12">
                        <nav>
